...
<div class="container">
    <div class="row">
        <div class="col-md-12" style="text-align: center;">
            ...
            <button style="background-color: darkturquoise; color: white;" type="button" class="btn  btn-arrow-right">Review</button>
    ...
    <h4 style="margin-top: 2%;">Review your itinerary</h4> </div>
<div class="hr">
