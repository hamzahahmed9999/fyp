    ...
    <div id="home" class="container" style="box-shadow: 0px 2px 30px rgba(0,0,0,0.30);margin-top: 2%;
        ...
        <div class="row" style="padding:2%">
            <div class="col-xs-12 col-sm-3 center">
                ...
                <a href="./addbankingplan.jsp" class="btn btn-sm btn-block btn-primary">

                    <span class="bigger-110">Add Plan</span>
                </a>

                <a href="./addproperty.jsp" class="btn btn-sm btn-block btn-outline-success">

                    <span class="bigger-110">Add Area</span>
                </a>
            </div><!-- /.col -->
                ...
                <div class="widget-box transparent">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <p>
                                We are a team of highly motivated indiviudals working together to get you the best value for your investment.
                            </p>
                            q
                        </div>
                    </div>
