...
<div>
    ...
    <div class="col-sm-8 container-fluid" style="background-color:#948A8A;height:800px; ">
        ...
        <div class="container" style="display:block;">
            ...
            <div><input type="number" value="Enter your amount here"/></div>
        ...
        <div class="container" style="display:block;">
            ...
            <div><input type="text" value="Enter your amount here"/></div>
            <div><label> Area</label></div>
            <div><input type="text" value="Enter your area here"/></div>
            <div><label> Size</label></div>
            <div><input type="text" value="Enter your size here"/></div>
